...
\section{Derp - ``you can use standard tools''}

\section{Explain components in compilation toolchain}
\begin{enumerate}
...
\section{Memory leaks in systems with dynamic memory management}
...
\section{Explain the diff. between communicating with an I/O device using memory mapped I/O or I/O-instructions}
TODO: !!! 

\section{Explain processor, register, program counter, cache, I/O device, instruction set architecture}
